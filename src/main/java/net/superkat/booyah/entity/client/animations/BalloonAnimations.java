package net.superkat.booyah.entity.client.animations;
...
public class BalloonAnimations {
        public static final AnimationDefinition IDLE = AnimationDefinition.Builder.withLength(4.0F).looping()
                ...
                .addAnimation("balloon_tie", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                        new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.375F, KeyframeAnimations.degreeVec(12.4539F, 1.0809F, -4.882F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.75F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.125F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.5F, KeyframeAnimations.degreeVec(12.4539F, 1.0809F, -4.882F), AnimationChannel.Interpolations.CATMULLROM),
                        ...
                        new Keyframe(2.375F, KeyframeAnimations.degreeVec(12.4539F, 1.0809F, -4.882F), AnimationChannel.Interpolations.CATMULLROM),
                        ...
                        new Keyframe(3.5F, KeyframeAnimations.degreeVec(12.4539F, 1.0809F, -4.882F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(3.875F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
                ))
                .addAnimation("weight", new AnimationChannel(AnimationChannel.Targets.ROTATION,
                ...
                .addAnimation("balloon", new AnimationChannel(AnimationChannel.Targets.POSITION,
                        new Keyframe(0.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(0.5F, KeyframeAnimations.posVec(0.0F, -0.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.0F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                        new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, -0.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                ...
                .addAnimation("balloon", new AnimationChannel(AnimationChannel.Targets.SCALE,
